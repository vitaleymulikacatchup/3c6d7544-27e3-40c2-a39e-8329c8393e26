...
export const metadata: Metadata = {
  title: "Ukrainian Bakery - Authentic Traditional Bread & Pastries",
  description: "Fresh Ukrainian bread and pastries made daily using traditional family recipes. Authentic rye bread, paska, and custom orders available.",
  keywords: "Ukrainian bakery, traditional bread, paska, rye bread, authentic pastries, fresh daily, custom orders",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "Ukrainian Bakery - Authentic Traditional Bread & Pastries",
    description: "Fresh Ukrainian bread and pastries made daily using traditional family recipes.",
    siteName: "Українська Пекарня",
    type: "website",
    images: [{
      url: "https://images.pexels.com/photos/5490924/pexels-photo-5490924.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "Traditional Ukrainian bakery interior"
    }]
  },
  twitter: {
    ...
    title: "Ukrainian Bakery - Authentic Traditional Bread & Pastries",
    description: "Fresh Ukrainian bread and pastries made daily using traditional family recipes.",
    images: ["https://images.pexels.com/photos/5490924/pexels-photo-5490924.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  }
};
